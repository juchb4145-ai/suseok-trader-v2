...
- generated_at: `2026-06-29T04:57:54.041170+00:00`
...
| Gateway | WARN | CORE_STATUS_ERROR | Gateway command failures exist: 2 |
| MarketData | BLOCK | MARKET_PROJECTION_ERROR, TICK_STALE, NO_CONDITION_HIT | Market projection errors exist: 3718 |
| Theme | PASS | - | theme_snapshots=100, LEADING=0, SPREADING=0 |
| Candidate | WARN | CANDIDATE_EMPTY | No active candidates exist. |
| Strategy | WARN | STRATEGY_EVALUATE_NOT_RUN | No strategy evaluation run exists. |
| Risk | WARN | RISK_EVALUATE_NOT_RUN | No risk run exists. |
