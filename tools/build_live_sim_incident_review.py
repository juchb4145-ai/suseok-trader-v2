...
def main() -> int:
    from services.ai_sidecar.live_sim_review_workflows import build_live_sim_incident_review
    from services.config import load_settings
    from storage.sqlite import initialize_database

    parser = argparse.ArgumentParser(description="Build a read-only LIVE_SIM incident review.")
    parser.add_argument("--trade-date", default=None)
    parser.add_argument("--related-entity-id", default=None)
