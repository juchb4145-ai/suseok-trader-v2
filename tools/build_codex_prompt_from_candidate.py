...
def main() -> int:
    from services.ai_sidecar.codex_prompt_generator import build_codex_prompt_from_candidate
    from services.config import load_settings
    from storage.sqlite import initialize_database

    parser = argparse.ArgumentParser(description="Build a Codex prompt draft from a candidate.")
    ...
    try:
        result = build_codex_prompt_from_candidate(
            connection,
