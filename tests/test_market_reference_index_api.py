...
def test_gateway_index_event_refreshes_common_context_without_throttle(
    tmp_path,
    monkeypatch,
) -> None:
    ...
    assert second_response.json()["projection_statuses"]["market_context"] == "APPLIED"
    assert second_response.json()["projection_statuses"]["market_regime"] == "NEUTRAL"
