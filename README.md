...
market-index worker/reconcile/dry-run 준비:

```powershell
python -m tools.ops_market_index_projection_check `
  --core-url http://127.0.0.1:8000 `
  --token $env:TRADING_CORE_TOKEN
```
...
- [docs/runbook_market_index_projection_ko.md](docs/runbook_market_index_projection_ko.md): market-index worker/reconcile/dry-run 준비
